...
with st.form("Take Input parameters : ", border=True):
    ...
    # st.form_submit_button("Predict", on_click=result_final())
        

# st.text("Project done by:\nParthsarathi\nShivam\nRajnish\nAbhijeet")
       
st.markdown(
    "<h1>Traffic Prediction<sup style='font-size:.8em;'>©</sup> done by: <br>Parthsarathi<br>Shivam<br>Rajnish<br>Abhijeet<br>under the guidance of <br>Miss Sonali Kapoor</h1>",
    unsafe_allow_html=True,
)

#TRYING TO ADD A BACKGROUND IMAGE
#FINAL RUN: NOT WORKING

# page_bg_img =""" <style>body {background-image: url("https://unsplash.com/photos/car-lot-surrounded-by-high-rise-building-102abqkKhbY");background-size: cover;}</style>"""

# st.markdown(page_bg_img, unsafe_allow_html=True)

# local_image = r"C:\Users\01psd\OneDrive\Desktop\bgPhoto.jpg"

# page_bg_img = f"""
# <style>
# body {{
#     background-image: url("file://{local_image}");
